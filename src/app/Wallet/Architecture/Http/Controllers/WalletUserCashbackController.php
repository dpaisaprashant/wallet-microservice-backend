...
class WalletUserCashbackController extends Controller
{
    ...
    public function create(Request $request, $id)
    {
        ...
        return view('Architecture::cashback.user.create')->with(compact('walletTransactionType', 'userTypes', 'availableTitles'));
    }
    ...
    {
        $cashback = SingleUserCashback::where('id', $request->id)->firstOrFail();
        $cashback->delete();
