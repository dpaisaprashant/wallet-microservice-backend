                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools" style="top: 8px;">
                            <a href="{{ route('architecture.trasnaction.cashback.create', $walletTransactionType->id) }}"><button class="btn btn-primary" type="button"><i class="fa fa-plus"></i> Create New Cashback</button></a>
                        </div>
                    </div>
                    <div class="ibox-content">
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                @foreach($walletTransactionType->walletTransactionTypeCashbacks as $cashback)
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">
                                            <a href="{{ route('architecture.trasnaction.cashback.update', $cashback->id) }}"><button class="btn btn-info btn-icon" type="button"><i class="fa fa-edit"></i></button></a>
                                            <form action="{{ route('architecture.trasnaction.cashback.delete') }}" method="post" id="deactivateForm" style="display: inline">
                                                @csrf
