                    ...
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tbody>
                                @foreach($walletTransactionType->singleUserCommissions as $commission)
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            {{ $commission->userCommissionable->name . "(" . $commission->userCommissionable->mobile_no .")" }}
                                        </td>
                                        <td>
                                        ...
                                        <td class="center">
                                            ...
                                            <form action="{{ route('architecture.user.commission.delete') }}" method="post" id="deactivateForm" style="display: inline">
                                                @csrf
                                                <input type="hidden" name="id" value="{{ $commission->id }}">
                                                <button class="btn btn-danger btn-icon deactivate" rel="{{ $commission->id }}"><i class="fa fa-trash"></i></button>
                                                <button id="deactivateBtn-{{ $commission->id }}" type="submit" style=" display:none;"  rel="{{ route('architecture.user.commission.delete') }}"></button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
