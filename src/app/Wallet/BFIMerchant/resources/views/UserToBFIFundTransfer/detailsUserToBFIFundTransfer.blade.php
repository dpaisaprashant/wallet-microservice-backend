                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="margin-top: 30px;">
                            ...
                            <address>
                                ...
                                @else
                                    {{ $userToBfiFundTransferCheckPaymentDetails->from_pre_transaction_id }}<br>
                                @endif
                                To Pre Transaction Id :
                                @if($userToBfiFundTransferCheckPaymentDetails->to_pre_transaction_id == null)
                                    <span class="badge badge-danger">Null</span><br>
                                @else
                        ...
                        <div class="col-sm-6 text-right" style="margin-top: 20px;">
                            ...
                            <p style="margin-top: 20px;">
                                ...
                                <span><strong>User to BFI fund Transfer Date</strong> : {{ date('d M, Y', strtotime($bfiToUserFundTransferDate[0])) }}</span>
                                                ...
                                                <div class="timeline-content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <address>
                                                                <strong>Transaction
                                                                    ID:</strong> {{ $userToBfiFundTransferCheckPaymentDetails->bfiCheckPayment->transaction_id }}
                                                                <br>
                                                                <strong>Bfi
                                                                    Id:</strong> {{ $userToBfiFundTransferCheckPaymentDetails->bfiCheckPayment->bfi_id }}
                                                                <br>
                                                                <strong>Wallet
                                                                    Id:</strong> {{ $userToBfiFundTransferCheckPaymentDetails->bfiCheckPayment->wallet_id }}
                                                                <br>
                                                                ...
                                                                @elseif($userToBfiFundTransferCheckPaymentDetails->bfiCheckPayment->status == "PROCESSING")
                                                                ...
                                                                @if(isset($userToBfiFundTransferCheckPaymentDetails->bfiCheckPayment->transaction_detail) == true)
                                                                    <strong>Transaction Detail
                                                                        : </strong>{{ $userToBfiFundTransferCheckPaymentDetails->bfiCheckPayment->transaction_detail }}
                                                                    <br>
                                                                @endif
                                                                <br>
                                                                <br>
                                                ...
                                                <div class="timeline-content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <address>
                                                                <strong>Transaction
                                                                    ID:</strong> {{ $userToBfiFundTransferCheckPaymentDetails->transaction_id }}
                                                                <br>
                                                                <strong>Bfi
                                                                    Id:</strong> {{ $userToBfiFundTransferCheckPaymentDetails->bfi_id }}
                                                                <br>
                                                                <strong>Wallet
                                                                    Id:</strong> {{ $userToBfiFundTransferCheckPaymentDetails->wallet_id }}
                                                                <br>
                                                                <strong>Status:</strong>
                                                                @if($userToBfiFundTransferCheckPaymentDetails->status == "SUCCESS")
                                                                    <span class="badge badge-primary">Success</span><br>
