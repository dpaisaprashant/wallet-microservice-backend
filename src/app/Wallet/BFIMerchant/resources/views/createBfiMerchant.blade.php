...
@section('content')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Create BFI Merchant </h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('admin.dashboard') }}">Home</a>
                </li>
                <li class="breadcrumb-item">
                    <a>Create BFI Merchant</a>
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>Add new BFI Merchant</h5>
                    </div>
                    <div class="ibox-content">
                        <form method="post"
                              action="{{ route('bfi.store') }}"
                            ...
                            <div class="form-group  row"><label class="col-sm-2 col-form-label">BFI Name</label>
                                <div class="col-sm-10">
                                    <select id="selectUserType" data-placeholder="ChooseUser Type..."
                                            class="chosen-select" tabindex="2" name="bfi_id" required>
                                        <option value="" selected disabled>-- Select BFI Name --</option>
                                        @foreach($bfi as $key=>$bfi)
                                            <option value="{{ $bfi->bfi_id }}">{{ $bfi->bfi_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group  row"><label class="col-sm-2 col-form-label">Merchant Name</label>
                                <div class="col-sm-10">
                                    <select id="selectCashbackType" data-placeholder="Choose wallet transaction type..."
                                            class="chosen-select" tabindex="2" name="merchant_id"
                                            required>
