...
Route::group(['prefix' => 'admin/cellPay-Transactions', 'middleware' => ['web','auth']], function () {
    ...
    Route::get('cellPay-transactions-list/detail/{id}',[CellPayUserTransactionController::class,'cellPayDetail'])->name('cellPayUserTransaction.detail')->middleware('permission:Cellpay user transaction detail');
});
