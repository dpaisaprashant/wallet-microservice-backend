...
class NPayAuditTrail implements IDPaisaAuditTrail
{
    ...
    {
        return round($transaction->transaction_fee, 3) ?? 0;
    }
    ...
    {
        $transactions =  UserLoadTransaction::with('loadTransactionResponse', 'commission')->get();
        $balance = 0;
