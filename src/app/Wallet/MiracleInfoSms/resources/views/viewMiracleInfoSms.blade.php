            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <form action="{{ route('miracle-info.view') }}" method="post" style="display: inline">
                                @csrf
                                <button class="btn btn-sm btn-primary"> Check balance</button>
                            </form>
                            @if($balance)
                                <b><p style="padding-top: 5px">{{$balance}}</p></b>
                            @endif
                        </div>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function (e) {
            let a = "Showing {{ $messages->firstItem() }} to {{ $messages->lastItem() }} of {{ $messages->total() }} entries";
