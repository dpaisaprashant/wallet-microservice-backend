    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>Audit Trail Mismatches</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>List Generated for Audit Trail Mismatch Reports</h5>
                    </div>

                    <div class="ibox-content">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example"
                                       title="Audit Trail Mismatch Report">
                                    <thead>
                                    <tr>
                                        <th>S.No.</th>
                                        <th>User Name</th>
                                        ...
                                        <th>Generated Balance</th>
                                        <th>Difference</th>
                                        <th>Created At</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($auditTrailMismatches as $report)
                                        <tr>
                                            <td>{{$loop->index+1}}</td>
                                            <td>{{$report->user->name}}</td>
                                            <td>{{$report->user->mobile_no}}</td>
                                            <td>{{$report->actual_balance}}</td>
                                            <td>{{$report->generated_balance}}</td>
