                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get">
                                    ...
                                    <br>
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit" formaction="{{ route('report.clientActivity') }}"><strong>Generate Report</strong></button>
                                    </div>
                ...
                @if(!empty($_GET['from']) && !empty($_GET['to']))
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Customer Activity report from {{ $_GET['from'] . ' to ' . $_GET['to'] }}</h5>
                        </div>
                        <div class="ibox-content">
