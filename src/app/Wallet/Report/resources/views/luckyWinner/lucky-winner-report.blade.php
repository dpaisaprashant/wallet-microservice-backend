    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>Lucky Winners Report</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get" action="{{ route('report.lucky.winner') }}"
                                      id="filter">
                                    <br>
                                    <div class="row">
                                    ...
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit"
                                                formaction="{{ route('report.lucky.winner') }}">
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>List Generated for Lucky Winners Report</h5>
                        </div>
...
{{--                            @else--}}
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover dataTables-example"
                                        ...
                                        <tbody>
                                        @foreach($luckyWinners as $luckyWinner)
                                            <tr>
                                                <td>{{$loop->index+1}}</td>
                                                <td>{{$luckyWinner->pre_transaction_id}}</td>
                                                <td>{{$luckyWinner->name}}</td>
                                                <td>{{$luckyWinner->mobile_no}}</td>
                                                <td>{{$luckyWinner->email}}</td>
                                                <td>{{$luckyWinner->amount}}</td>
                                                <td>{{$luckyWinner->created_at}}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
