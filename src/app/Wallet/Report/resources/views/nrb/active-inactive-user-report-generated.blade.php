                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-warning m-t-n-xs"
                                               ...
                                               href="{{ route('report.active.inactive.user',['from'=>$convertedDate]) }}">
                                            ...
                                            <form action="{{ route('report.active.inactive.user.delete',$report->id) }}"
                                                  method="POST">
                                                @csrf
                                                <button id="resetBtn-{{ $report->id }}"
                                                        style="display: none" type="submit"
                                                        href="{{ route('report.active.inactive.user.delete',$report->id) }}"
