...
@section('content')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Generated NRB Annex 10.1.11 Reports</h2>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>Generated NRB Annex 10.1.11 Reports</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>List of Generated NRB Annex 10.1.11 Reports</h5>
                    </div>
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example"
                                   title="Generated NRB Annex 10.1.11 Reports">
                                <thead>
                                <tr>
                                    <th>S.N.</th>
                                    <th>From Date</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-warning m-t-n-xs"
                                               ...
                                               href="{{ route('report.nrb.annex.agent.payment',['from'=>$convertedFromDate,'to'=>$convertedToDate]) }}">
                                                <strong><i class="fa fa-bar-chart"></i> &nbsp;View More</strong></a>

                                            <button
                                                class="reset btn btn-sm btn-danger m-t-n-xs"
                                                rel="{{ $report->from_date }}-{{$report->to_date}}"><i
                                                    class="fa fa-trash"></i>
                                            </button>

                                            <form action="{{ route('report.nrb.annex.agent.payment.delete', ['fromDate'=>$report->from_date,'toDate'=>$report->to_date]) }}"
                                                  method="POST">
                                                @csrf
                                                <button id="resetBtn-{{ $report->from_date }}-{{$report->to_date}}"
                                                        style="display: none" type="submit"
                                                        href="{{ route('report.nrb.annex.agent.payment.delete', ['fromDate'=>$report->from_date,'toDate'=>$report->to_date]) }}"
