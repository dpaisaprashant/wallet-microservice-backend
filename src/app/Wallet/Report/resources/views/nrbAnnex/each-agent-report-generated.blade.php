...
@section('content')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Generated NRB Each Agent Reports</h2>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>Generated NRB Each Agent Reports</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>List of Generated NRB Each Agent Reports</h5>
                    </div>
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example"
                                   title="Generated NRB Each Agent Reports">
                                <thead>
                                <tr>
                                    <th>S.N.</th>
                                    <th>From Date</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-warning m-t-n-xs"
                                               ...
                                               href="{{ route('report.nrb.annex.agent.each',['from_date'=>$convertedFromDate,'to_date'=>$convertedToDate]) }}">
                                            ...
                                            <form action="{{ route('report.nrb.annex.agent.each.delete', $report->id) }}"
                                                  method="POST">
                                                @csrf
                                                <button id="resetBtn-{{ $report->id }}"
                                                        style="display: none" type="submit"
                                                        href="{{ route('report.nrb.annex.agent.each.delete', $report->id) }}"
