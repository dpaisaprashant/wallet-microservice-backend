    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>NRB Annex 10.1.6</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get" action="{{ route('report.nrb.annex.merchant.payments') }}"
                                      id="filter">
...
{{--                                        </div>--}}
                                    ...
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit"
                                                formaction="{{ route('report.nrb.annex.merchant.payments') }}">
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>List Generated for NRB Annex 10.1.6 Report</h5>
                        </div>
                        <div class="ibox-content">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example"
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="2" style="text-align: center">Count</th>
                                    </tr>
                                    <tr>
                                        <th>Successful</th>
                                        <th>Failed</th>
                                    ...
                                    <tbody>
                                    @foreach($nrbAnnexMerchantPayments as $title=>$nrbAnnexMerchantPayment)
                                        <tr>
                                            <td>{{$loop->index+1}}</td>
                                            <td>{{$title}}</td>
                                            <td>{{$nrbAnnexMerchantPayment['successful']}}</td>
                                            <td>{{$nrbAnnexMerchantPayment['failed']}}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
