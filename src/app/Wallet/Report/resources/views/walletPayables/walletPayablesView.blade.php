        ...
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>View Wallet Payables</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
...
{{--                                        </div>--}}
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <select data-placeholder="Select Pre-Transaction Wallet Payables..."
                                    ...
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit"
                                                formaction="{{ route('report.walletPayablesReport') }}"><strong>Filter</strong></button>
                                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example"
                                ...
                                @foreach($preTransactions as $preTransaction)
                                    <tr class="gradeC">
                                        ...
                                        <td>{{$preTransaction->balance_status}}</td>
                                        <td>
