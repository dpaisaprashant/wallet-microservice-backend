...
Route::group(['prefix' => 'admin/report', 'middleware' => ['web', 'auth']], function () {
    ...
    Route::match(['get', 'post'], 'reconciliation-report', [WalletReportController::class, 'dailyDashboard'])->name('report.dailyDashboard')->middleware('permission:Report reconciliation');
