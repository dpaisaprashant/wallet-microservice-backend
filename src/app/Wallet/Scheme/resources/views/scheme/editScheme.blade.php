            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="{{ route('scheme.update',$scheme->id) }}" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group  row"><label class="col-sm-2 col-form-label">Scheme Name</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-sm" name="scheme_name" value="{{ $scheme->name }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group  row"><label class="col-sm-2 col-form-label">Allow Cashback</label>
                                <div class="col-sm-10">
                                    <select id="selectUserType" data-placeholder="Allow Cashback..."
                                        ...
                                        <option value="1" {{ $scheme->allow_cashback == "1" ? "selected" : "" }}>True</option>
                                        <option value="0" {{ $scheme->allow_cashback == "0" ? "selected" : "" }}>False</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group  row"><label class="col-sm-2 col-form-label">Allow Commission</label>
                                <div class="col-sm-10">
                                    <select id="selectUserType" data-placeholder="Allow Commission..."
                                        ...
                                        <option value="1" {{ $scheme->allow_commission == "1" ? "selected" : "" }}>True</option>
                                        <option value="0" {{ $scheme->allow_commission == "0" ? "selected" : "" }}>False</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group  row"><label class="col-sm-2 col-form-label">Validate KYC</label>
                                <div class="col-sm-10">
                                    <select id="selectUserType" data-placeholder="Validate KYC..."
                                        ...
                                        <option value="1" {{ $scheme->validate_kyc == "1" ? "selected" : "" }}>True</option>
                                        <option value="0" {{ $scheme->validate_kyc == "0" ? "selected" : "" }}>False</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group  row"><label class="col-sm-2 col-form-label">Status</label>
                                <div class="col-sm-10">
                                    <select id="selectUserType" data-placeholder="ChooseUser Type..."
                                        ...
                                        <option value="0" {{ $scheme->status == "0" ? "selected" : "" }}>In-active</option>
                                    </select>
                                </div>
                            </div>
