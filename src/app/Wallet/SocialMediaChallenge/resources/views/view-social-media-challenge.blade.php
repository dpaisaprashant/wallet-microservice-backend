                        ...
                        <div class="ibox-content">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example"
                                    ...
                                    <tbody>
                                    @foreach($socialMediaChallengers as $socialMediaChallenger)
                                        <tr class="gradeC">
                                            <td>{{ $loop->index + ($socialMediaChallengers->perPage() * ($socialMediaChallengers->currentPage() - 1)) + 1 }}</td>
                                            <td>{{ $socialMediaChallenger->account_name }}</td>
                                            <td>{{ $socialMediaChallenger->account_number }}</td>
                                            <td>{{ $socialMediaChallenger->bank_code }}</td>
                                            <td>{{ $socialMediaChallenger->dob }}</td>
                                            <td>{{ $socialMediaChallenger->mobile_number }}</td>
                                            <td>{{ $socialMediaChallenger->reference_id }}</td>
                                            <td>{{ $socialMediaChallenger->register_date }}</td>
                                            <td>
