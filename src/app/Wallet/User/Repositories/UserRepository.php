...
class UserRepository
{
    ...
    {
        $unsortedUsers = User::with('wallet', 'kyc', 'userType','merchant','agent')->whereHas('userType')->filter($this->request)->get();
    ...
    public function rejectedKycUsers(){
        $rejectedKycUsers = User::with('wallet', 'kyc', 'userType','merchant','agent','kyc')->whereHas('userType')->whereHas('kyc',function($query){
    ...
    public function acceptedKycUsers(){
        $acceptedKycUsers = User::with('wallet', 'kyc', 'userType','merchant','agent','kyc')->whereHas('userType')->whereHas('kyc',function($query){
    ...
    public function pendingKycUsers(){
        $pendingKycUsers = User::with('wallet', 'kyc', 'userType','merchant','agent','kyc')->whereHas('userType')->whereHas('kyc',function($query){
    ...
    public function kycNotFilledUsers(){
        $kycNotFilledUsers = User::with('wallet', 'kyc', 'userType','merchant','agent','kyc')->whereHas('userType')->doesntHave('kyc')->filter(request())->get();
    ...
    {
        return User::with('wallet', 'kyc', 'userType','merchant','agent')->whereHas('userType')->filter($this->request)->paginate($this->length);
    }

    private function latestUsers()
    {
        return User::with('wallet', 'kyc', 'userType','merchant','agent')->whereHas('userType')->latest()->filter($this->request)->paginate($this->length);
