...
class NchlBankTransferAddToTransactionEventCron
{
    use DebitResponse;
    ...
    public function __invoke()
    {
        ...
        foreach ($preTransactions as $preTransaction) {
            ...
            $microservice->setBaseUrl(config('microservices.' . 'NCHL'))
                ->setUrl("/wallet-transaction/bank-transfer/get")
            ...
            if (isset($response['pre_transaction_status'])) {
                ...
                $walletTransactionType = $validator->nchlBankTransferValidation()->getWalletTransactionType();
