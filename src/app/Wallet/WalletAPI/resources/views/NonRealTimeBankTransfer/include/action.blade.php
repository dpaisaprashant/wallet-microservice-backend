<a data-toggle="modal" href="#modal-form-nchl-load-transaction-validation-response{{$transaction_id}}" title="Account">
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="width: 700px;">
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="m-t-none m-b">Account</h3>
                        <hr>
                        <dl class="row m-t-md">

                            <?php $response = json_decode($account, true) ?>
