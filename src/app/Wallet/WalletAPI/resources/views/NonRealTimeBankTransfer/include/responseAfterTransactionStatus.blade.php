<a data-toggle="modal" href="#modal-form-nchl-load-transaction-validation-response{{$transaction_id}}" title="Response after checking status">
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="width: 700px;">
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="m-t-none m-b">Response After Transaction Status</h3>
                        <hr>
                        <dl class="row m-t-md">
                            ...
                            <?php } ?>
                                @else
                                    <dt class="col-md-5 ml-2"><b>No Response</b></dt>
                            @endif
                        </dl>
                    </div>
                </div>
