...
@section('content')
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        @php
            $nchlresponse = json_decode($response,true);
        @endphp
        @if(!empty($nchlresponse))

                @if (is_array($nchlresponse) || is_object($nchlresponse))
                    <table class="table table-striped table-bordered table-hover dataTables-example"
                        ...
                        <tbody>
                            @foreach ($nchlresponse as $key=>$value)
                                <tr class="gradeC">
                                @if(!is_array($value))
                                    <td>{{ $key }} :</td>
