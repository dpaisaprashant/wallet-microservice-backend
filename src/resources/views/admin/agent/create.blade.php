            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <form method="post" action="{{ route('agent.create') }}" enctype="multipart/form-data"
                              id="transactionIdForm">
                            @csrf
                            <div class="form-group  row"><label class="col-sm-2 col-form-label">Mobile No. <small>(required)</small></label>
                                <div class="col-sm-10">
                                    <select id="selectTransaction" data-placeholder="Choose Mobile No..."
                                            class="chosen-select" tabindex="2" name="user_id" required>
                                        <option value="" selected disabled>--- Select Mobile No. ---</option>
                                        @foreach($users as $user)
                                            <option
                                                value="{{ $user->id }}">{{ $user->name . ' - ' . $user->mobile_no }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <select id="code_used_id" data-placeholder="Choose Agent Type..."
                                            class="chosen-select" tabindex="2" name="code_used_id">
                            ...
                            <div class="form-group  row" id="use_parent_balance" style="display: none">
                            ...
                            <div class="form-group  row"><label class="col-sm-2 col-form-label">Institution Type <small>(required)</small></label>
                                <div class="col-sm-10">
                                    <select data-placeholder="Choose Mobile No..." class="chosen-select" tabindex="2"
                                        ...
                                        <option
                                            value="{{ \App\Models\Agent::INSTITUTION_TYPE_COMPANY }}">{{ \App\Models\Agent::INSTITUTION_TYPE_COMPANY }}</option>
                                        <option
                                            value="{{ \App\Models\Agent::INSTITUTION_TYPE_INDIVIDUAL }}">{{ \App\Models\Agent::INSTITUTION_TYPE_INDIVIDUAL }}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group  row"><label class="col-sm-2 col-form-label">Business Owner
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <label for="business_owner_citizenship_back" class="custom-file-label">Upload
                                        Citizenship Back Image...</label>
                                </div>
                            </div>

                            <div class="form-group  row"><label class="col-sm-2 col-form-label">Business Document Image
                            ...
                            <div class="form-group  row"><label class="col-sm-2 col-form-label">Pan/Vat Document <small>(required)</small></label>
                                <div class="col-sm-10">
                                    ...
                                    <label for="pan_vat_document" class="custom-file-label">Upload Pan/Vat
                                        document</label>
                                </div>
                            </div>

                            <div class="hr-line-dashed"></div>
                            <button class="btn btn-sm btn-primary m-t-n-xs" type="submit"><strong>Create Agent</strong>
                            </button>
                        </form>
                    </div>
                </div>
