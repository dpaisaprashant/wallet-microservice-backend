                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get" >
                                    ...
                                    <div>
                                        <br>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit" formaction="{{ route('auditTrail.nPay') }}"><strong>Filter</strong></button>
                                    </div>
                                    <div>
                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example" title="SajiloPay Audit Trial - NPay">
                                <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Date</th>
