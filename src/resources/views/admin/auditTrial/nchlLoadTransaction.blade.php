...
@section('content')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Nchl Load Transaction Audit Trial</h2>
            <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get" >
                                    ...
                                    <div>
                                        <br>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit" formaction="{{ route('auditTrail.nchl.loadTransaction') }}"><strong>Filter</strong></button>
                                    </div>
                                    <div>
                                        <button id="excelBtn" class="btn btn-sm btn-warning float-right m-t-n-xs" type="submit" style="margin-right: 10px;" formaction="{{ route('nchl-load-transaction-audit-trail') }}"><strong>Excel</strong></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example" title="Dpaisa Audit Trial - Nchl Load Transaction">
                                <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Date</th>
                                ...
                                @foreach($events as $event)
                                    @if($event instanceof \App\Models\NchlLoadTransaction)
