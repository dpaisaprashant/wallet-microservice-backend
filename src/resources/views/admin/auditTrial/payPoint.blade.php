                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get" >
                                    ...
                                    <div>
                                        <br>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit" formaction="{{ route('auditTrail.payPoint') }}"><strong>Filter</strong></button>
                                    </div>
                                    <div>
                                        <button id="excelBtn" class="btn btn-sm btn-warning float-right m-t-n-xs" type="submit" style="margin-right: 10px;" formaction="{{ route('ppAuditTrail.excel') }}"><strong>Excel</strong></button>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example" title="SajiloPay Audit Trial - PayPoint">
                                <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Date</th>
                                ...
                                @foreach($events as $event)
                                    @if($event instanceof \App\Models\UserCheckPayment)
