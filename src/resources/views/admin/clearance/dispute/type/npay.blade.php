<div class="ibox ">
    <div class="ibox-title">
        <h5>USER LOAD TRANSACTION DISPUTE</h5>
    </div>
    ...
    <div class="ibox-content">
        ...
        <div class="form-group  row">
            ...
            <div class="col-sm-10">
                <input value="{{ $transaction->transaction_id }}" name="transaction_id" type="text" class="form-control" disabled>
            </div>
        </div>
        ...
        <div class="form-group  row">
            ...
            <div class="col-sm-10">
                <input value="{{ $transaction->gateway_ref_no }}" name="gateway_ref_no" type="text" class="form-control" disabled>
            </div>
        </div>
        ...
        <div class="form-group  row">
            ...
            <div class="col-sm-10">
                <input value="{{ $transaction->process_id }}" name="process_id" type="text" class="form-control" disabled>
            </div>
        </div>
