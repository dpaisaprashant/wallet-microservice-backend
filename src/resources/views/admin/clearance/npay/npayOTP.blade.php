...
<head>
    ...
    <title>SajiloPay Clearance | OTP </title>
...
<div class="loginColumns animated fadeInDown">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <p>Enter otp code to view Npay clearance transactions </p>

        </div>
        <div class="col-md-6">

            <div class="ibox-content">
                <form class="m-t" role="form" action="{{ route('npay.clearance.otp') }}" method="post" autocomplete="off">
                    @csrf
