                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get">
                                    ...
                                    <br>
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit" formaction="{{ route('clearance.npayView') }}"><strong>Filter</strong></button>
                                    </div>
                                    <div>
                                        <button id="excelBtn" class="btn btn-sm btn-warning float-right m-t-n-xs" type="submit" style="margin-right: 10px;" formaction="{{ route('clearance.npay.excel') }}"><strong>Excel</strong></button>
                                    </div>
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>List of npay clearances</h5>
                    </div>
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example" title="NPay clearances">
                                <thead>
                                <tr>
                                    <th>S.No.</th>
                                ...
                                @foreach($clearances as $clearance)
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">
                                            ...
                                            @can('Clearance npay transactions view')
                                                <a style="margin-top: 5px;"
                                                   class="btn btn-sm btn-info m-t-n-xs btn-icon"
                                                   href="{{ route('npay.clearance.transactions', $clearance) }}"
                                            ...
                                            @if($clearance->clearance_status !== null)
                                                <a style="margin-top: 5px;"
                                                   class="btn btn-sm btn-info m-t-n-xs btn-icon"
                                                   href="{{route('npay.generateClearanceReport', $clearance->id)}}"
