    ...
    <div class="row" style="margin-top: 14px">
        ...
        <div class="col-lg-2">
            <div class="ibox ">
                <div class="ibox-title" style="padding-right: 15px;">
                    <span class="label label-success float-right">Total</span>
                    <h5>Successful amount sum</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins">Rs. {{ $transactionAmountSum }}</h1>
                    <small>Sum of successful transactions of clearance</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-2">
            <div class="ibox ">
                <div class="ibox-title" style="padding-right: 15px;">
                    <span class="label label-success float-right">Total</span>
                    <h5>Total Transaction Fee</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins">Rs. {{ $totalTransactionFee }}</h1>
                    <small>Sum of transactions fee</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-2">
            <div class="ibox ">
                <div class="ibox-title" style="padding-right: 15px;">
                    <span class="label label-success float-right">Total</span>
                    <h5>Transaction net sum</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins">Rs. {{ $totalNetAmount }}</h1>
                    <small>Transaction Amount - Transaction Fee</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-2">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    ...
                    <small>Disputes while creating clearance</small>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get">
                                    ...
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit" formaction="{{ route('npay.clearance.transactions', $clearance) }}"><strong>Filter</strong></button>
                                    </div>
                                    <div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" title="Transactions cleared on {{ $clearance->created_at }}">
                                ...
                                @foreach($clearanceTransactions as $transaction)
                                    <tr class="gradeC">
                                        ...
                                        <td class="center">Rs. {{ $transaction->clearanceable->transaction_fee ?? 0}}</td>
                                        <td class="center">Rs. {{ $transaction->clearanceable->amount - $transaction->clearanceable->transaction_fee}}</td>
                                        <td>
