    ...
    <div class="row" style="margin-top: 14px">
        ...
        <div class="col-lg-2">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <h1 class="no-margins">Rs. {{ $totalRevenue }}</h1>
                    <small>Sum of revenue in transactions</small>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get">
                                    ...
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit" formaction="{{ route('paypoint.clearance.transactions', $clearance) }}"><strong>Filter</strong></button>
                                    </div>
                                    <div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" title="Transactions cleared on {{ $clearance->created_at }}">
                                ...
                                @foreach($clearanceTransactions as $transaction)
                                    <tr class="gradeC">
                                        ...
                                        <td class="center">
                                            @isset($transaction->clearanceable->excelTransaction['revenue'])
                                                Rs. {{ $transaction->clearanceable->excelTransaction['revenue'] }}
                                            @else
                                                ---
                                            @endisset
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            @elseif($transaction->transaction_type == 'App\Models\UserTransaction')
                                                ...
                                                <a href="{{ route('paypoint.detail', $transaction->clearanceable->checkTransaction->id) }}">
                                                    <button class="btn btn-primary btn-icon" type="button"><i
                                                            class="fa fa-eye"></i></button>
                                                </a>
