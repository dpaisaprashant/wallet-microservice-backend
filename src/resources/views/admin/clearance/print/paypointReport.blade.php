...
<head>
    ...
    <title>PayPoint Clearance-{{ \Carbon\Carbon::now() }}</title>
    ...
    <div class="ibox-content p-xl">
        ...
        <div class="table-responsive m-t">
            <table class="table">
                ...
                <tbody>
                <tr>
                    <td>Transaction type: Paypoint</td>
                </tr>
                <tr>
                    <td>Transaction count: {{ $clearance->total_transaction_count }}</td>
                </tr>
                <tr>
                    <td>Total transaction amount: Rs. {{ $clearance->total_transaction_amount}}</td>
                </tr>
                <tr>
                    <td>Total Transaction Fee: Rs. {{ (new \App\Models\UserTransaction())->getTotalTransactionFee($transactions) }}</td>
                </tr>
                <tr>
                    <td>Total Commission Amount: Rs. {{ (new \App\Models\UserTransaction())->getTotalCommission($transactions) }}</td>
                </tr>

                <tr>
                    <td>Total Cash Back Amount: Rs. {{ (new \App\Models\UserTransaction())->getTotalCashback($transactions) }}</td>
                </tr>
                </tbody>
            </table>
