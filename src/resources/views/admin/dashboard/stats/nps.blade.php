            ...
            <div class="col-lg-2">
                <div class="ibox ">
                    <div class="ibox-title" style="padding-right: 15px;">
                        ...
                        <h5>Nps Transaction Count</h5>
                    </div>
                    <div class="ibox-content">
                        <h1 class="no-margins">{{ $stats['yesterday']['transaction']['count'] }} </h1>
                        <small>Sum of Nps dispute transactions</small>
                    </div>
                </div>
            </div>
            <div class="col-lg-2">
                <div class="ibox ">
                    <div class="ibox-title" style="padding-right: 15px;">
                        <span class="label label-success float-right">Total</span>
                        <h5>Nps Transaction Amount</h5>
                    </div>
                    <div class="ibox-content">
                        <h1 class="no-margins">Rs. {{ $stats['yesterday']['transaction']['amount'] }} </h1>
                        <small>Sum of Nps Transactions </small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <small>Number of Nps dispute transactions</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <small>Number of Nps resolved transactions</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <small>Sum of Nps resolved transactions </small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5 id="graphTitleNps">Nps Vendors Graph</h5>
                    </div>
