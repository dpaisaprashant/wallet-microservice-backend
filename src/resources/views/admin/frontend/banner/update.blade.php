            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="{{ route('frontend.banner.update', $banner->id) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <div class="custom-file">
                                        <input name="mobile_image" id="logo1" type="file" class="custom-file-input">
                                        <label for="logo1" class="custom-file-label">Choose file...</label>
                                    </div>
