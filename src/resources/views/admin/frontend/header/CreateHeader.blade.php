            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="{{route('frontend.header.create')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group  row">
                                <label class="col-sm-2 col-form-label">Top Title</label>
                                <div class="col-sm-10">
                                    <input placeholder="Enter top title" name="top_title" type="text"
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="Enter bottom title" name="bottom_title" type="text"
                                           class="form-control" required>
                                </div>
                            </div>
                        @if(strtolower(config('app.'.'name')) == 'dpaisa'|| strtolower(config('app.'.'name')) == 'master')
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="Enter sub title" name="sub_title" type="text"
                                           class="form-control" required>
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="Enter google play store link" name="google_link" type="text"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group  row">
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="Enter app store link" name="apple_link" type="text"
                                           class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="Enter Button Text" name="button_text" type="text"
                                           class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="Enter Button Link" name="button_link" type="text"
                                           class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="Enter Service Header" name="service_header" type="text"
                                           class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="Enter Sequence" name="sequence" type="number"
                                           class="form-control">
                                </div>
                            </div>
