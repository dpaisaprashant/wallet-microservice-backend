        ...
        <div class="row m-b-lg m-t-lg">
            <div class="col-md-4" style="margin-top: 20px;">
                <div class="profile-image">
                    @isset($merchant->kyc['company_logo'])
                                                    ...
                                                    @can('KYC accept')
                                                        <div class="col-md-2" style="padding-right: 0px; margin-left: -45px;">
                                                            <form id="kycForm" action="{{ route('merchant.changeKYCStatus') }}" method="post">
                                                                ...
                                                                <button rel="{{ route('merchant.changeKYCStatus') }}" id="accept" class="btn btn-primary btn-sm" type="submit">Accept</button>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="row">
                                                                                    <div class="col-sm-12">
                                                                                        ...
                                                                                        <button style="width: 100%" rel="{{ route('merchant.changeKYCStatus') }}" id="reject" class="btn btn-danger " >Reject</button>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
