    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>{{ $merchant['name'] }} Merchant Login attempts</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example" title="Login attempts - {{ $merchant['name'] }}">
                                <thead>
                                <tr>
                                    <th>S.No.</th>
                                    <th>Public IP</th>
                                ...
                                @foreach($attempts as $attempt)
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('merchant.loginAttemptsUpdate') }}" method="post">
                                                @csrf
