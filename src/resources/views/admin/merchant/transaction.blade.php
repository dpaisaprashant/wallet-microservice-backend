    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>{{ $merchant->name }}'s transaction</strong>
                </li>
            </ol>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get">
                                    <input type="hidden" name="user" placeholder="Email or Number" class="form-control" value="{{$merchant->mobile_no}}">

                                    <div class="row">

                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="text" name="uid" placeholder="Merchant Transaction ID" class="form-control" value="{{ !empty($_GET['uid']) ? $_GET['uid'] : '' }}">
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit" formaction="{{ route('merchant.transaction', $merchant->id) }}"><strong>Filter</strong></button>
                                    </div>
                                    {{--<div>
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>List of {{ $merchant->name }}'s transactions</h5>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                @foreach($transactions as $transaction)
                                    <tr class="gradeC">
                                        ...
                                        <td>
                                            {{ $transaction->merchant['mobile_no'] }}
                                        </td>
                                        <td>
                                            {{ $transaction->vendor }}
                                        </td>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Transactions of {{ $merchant['mobile_no'] }} account'},
                    {extend: 'pdf', title: 'Transactions of {{ $merchant['mobile_no'] }} account'},
                    {extend: 'print',
