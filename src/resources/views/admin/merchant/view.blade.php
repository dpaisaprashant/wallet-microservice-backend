                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="text" name="name" placeholder="Enter Merchant Name" class="form-control" value="{{ !empty($_GET['name']) ? $_GET['name'] : '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <br>
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit" formaction="{{ route('merchant.view') }}"><strong>Filter</strong></button>
                                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" title="Dpasis user's list">
                                ...
                                @foreach($merchants as $merchant)
                                    ...
                                    <td class="center">
                                            ...
                                            <a style="margin-top: 5px;" href="{{route('merchant.profile', $merchant->id)}}" class="btn btn-sm btn-icon btn-primary m-t-n-xs" title="merchant profile"><i class="fa fa-eye"></i></a>
