    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>Merchant Transaction</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                            ...
                            <div class="col-sm-12">
                                <form role="form" method="get" action="{{ route('transaction.complete') }}" id="filter">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" name="user_id" placeholder="Email or number" class="form-control" value="{{ !empty($_GET['user_id']) ? $_GET['user_id'] : '' }}">
                                            </div>
                                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" title="Complete transactions list">
                                ...
                                @foreach($transactions as $transaction)
                                    <tr class="gradeC">
                                        ...
                                        <td>{{optional($transaction->transactions)->pre_transaction_id}}</td>
                                        <td>
                                            <a  @can('User profile') href="{{route('user.profile', $transaction->merchant_id)}}" @endcan> {{ $transaction->merchant->mobile_no ?? "---" }} </a>
                                        ...
                                        <td>
                                            <a href="{{route('merchant-transaction.detail',$transaction->id)}}"><button class="btn btn-primary btn-icon" type="button"><i class="fa fa-eye"></i></button></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
