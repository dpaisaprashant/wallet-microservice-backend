                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <select data-placeholder="Choose transaction status..." class="chosen-select"  tabindex="2">
                                                                                <option value="" selected disabled>Select PayPoint...</option>
                                                                                <option value="All">All</option>

                                                                                <option disabled style="font-weight: bold">Mobile Operators</option>
                                                                                    <option value="ntc" >&nbsp;&nbsp;&nbsp;&nbsp; NTC</option>
                                                                                    <option value="ncell" >&nbsp;&nbsp;&nbsp;&nbsp; NCell</option>
                                                                                    <option value="smartcell" >&nbsp;&nbsp;&nbsp;&nbsp; SmartCell EPIN</option>
                                                                                    <option value="smartcell_topup" >&nbsp;&nbsp;&nbsp;&nbsp; SmartCell Top-Up</option>
                                                                                    <option value="ntc_cdma" >&nbsp;&nbsp;&nbsp;&nbsp; NTC-CDMA</option>
                                                                                <option disabled style="font-weight: bold">Internet Payments</option>
                                                                                    <option value="subisu" >&nbsp;&nbsp;&nbsp;&nbsp; Subisu</option>
                                                                                    <option value="vianet" >&nbsp;&nbsp;&nbsp;&nbsp; Vianet</option>
                                                                                    <option value="worldlink" >&nbsp;&nbsp;&nbsp;&nbsp; WorldLink</option>
                                                                                    <option value="sky" >&nbsp;&nbsp;&nbsp;&nbsp; Sky</option>
                                                                                    <option value="web_surfer" >&nbsp;&nbsp;&nbsp;&nbsp; Web Surfer</option>
                                                                                <option disabled style="font-weight: bold">Utility Payments</option>
                                                                                    <option value="top_up" >&nbsp;&nbsp;&nbsp;&nbsp; Top Up</option>
                                                                                    <option value="landline" >&nbsp;&nbsp;&nbsp;&nbsp; Landline</option>
                                                                                    <option value="khanepani" >&nbsp;&nbsp;&nbsp;&nbsp; Khanepani</option>
                                                                                    <option value="nepal_water" >&nbsp;&nbsp;&nbsp;&nbsp; Nepal Water</option>
                                                                                    <option value="nepal_water" >&nbsp;&nbsp;&nbsp;&nbsp; Nepal Water</option>
                                                                                <option disabled style="font-weight: bold">TV</option>
                                                                                    <option value="dish_home" >&nbsp;&nbsp;&nbsp;&nbsp; Dish Home</option>
                                                                                    <option value="sim_tv" >&nbsp;&nbsp;&nbsp;&nbsp; Sim TV</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                            ...
                            <div class="daily">
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="ibox ">
                                            <div class="ibox-title">
                                                <span class="label label-success float-right">Daily</span>
                                        ...
                                        <div class="ibox ">
                                            <div class="ibox-title">
                                                <div style="width: 38%">
                                                    ...
                                                    <div class="input-group date" style="float: right; width: 31%; margin-top: -9px; border-color: #1E78A2">
                                ...
                                <i class="fa fa-calendar"></i>
                                            ...
                                            <div class="ibox-content">
                                                <div>
                                                    <canvas id="lineChart_daily" height="60"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        var ctx = document.getElementById("lineChart_daily").getContext("2d");
