                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get">
                                    ...
                                    <br>
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit" formaction="{{ route('report.npay') }}"><strong>Generate Report</strong></button>
                                    </div>
            ...
            <div class="col-lg-12">
                @if(!empty($_GET['from']) && !empty($_GET['to']))
                    ...
                    <div class="ibox-title">
                        <h5>NPay report from {{ $_GET['from'] . ' to ' . $_GET['to'] }}</h5>
                    </div>
                    <div class="ibox-content">
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" title="Wallet user's list">
                                ...
                                @foreach($services as $key => $service)
                                    <tr class="gradeX">
                                        ...
                                        <td>Rs. {{ $service['transactionFee'] }}</td>

                                        <td>Rs. {{ $service['totalAmount'] }}</td>
                                    </tr>
                                    <?php
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>Rs. {{ $totalTransactionFee }}</td>
                                    <td>Rs. {{ $finalTotalAmount}}</td>
                                </tr>
                                </tfoot>
                            </table>
                        </div>
