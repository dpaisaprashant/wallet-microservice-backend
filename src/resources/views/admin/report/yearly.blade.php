...
@section('content')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Yearly Transaction Report</h2>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>Yearly Transaction</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <form role="form" method="get">
                                                                ...
                                                                <br>
                                                                <div>
                                                                    <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit" formaction="{{ route('report.yearly') }}"><strong>Filter</strong></button>
                                                                </div>

                                                                <div>
                                                                    <button id="excelBtn" class="btn btn-sm btn-warning float-right m-t-n-xs" type="submit" style="margin-right: 10px;" formaction="{{ route('report.yearly.excel') }}"><strong>Excel</strong></button>
                                                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ibox ">
                                            ...
                                            <div class="ibox-content">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <form id="yearlyGraphForm" role="form" method="post" action="{{ route('report.yearly.graph') }}">
                                                            @csrf
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                ...
                                                <div class="load_graph">
                                                    <canvas id="lineChart_yearly" height="80"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="ibox ">
                                            <div class="ibox-title">
                                                ...
                                                <div class="ibox-content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <form id="yearlyVendorGraphForm" role="form" method="post" action="{{ route('report.yearly.vendor.graph') }}">
                                                                @csrf
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
   ...
   @include('admin.asset.js.datatable')
    ...
    <script>
        ...
        $('#transactionGraphTabButton').one('click', function (e) {
            $("#yearlyGraphForm").submit();
        });

        $('#yearlyGraphForm').submit(function (e) {
            e.preventDefault();
        ...
        function loadLineGraph(respData) {
            ...
            var ctx = document.getElementById("lineChart_yearly").getContext("2d");
