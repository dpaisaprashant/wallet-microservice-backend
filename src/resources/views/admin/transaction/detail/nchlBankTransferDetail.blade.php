                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="margin-top: 30px;">
                            ...
                            <address>
                                ...
                                Debit Status:     @include('admin.transaction.nchlBankTransfer.debitStatus')<br>
                                Credit Status:     @include('admin.transaction.nchlBankTransfer.creditStatus')
                            </address>
                                   ...
                                   <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2">
                                       <ul class="timeline">
                                           ...
                                           <li class="timeline-item">
                                               ...
                                               <div class="timeline-content">
                                                   <h2 class="timeline-title">Bank Transfer Request</h2>
