                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="margin-top: 30px;">
                            ...
                            <address>
                                ...
                                Reference Id: {{ $transaction->reference_id }}<br>
                                Remark: {{ $transaction->remark }}<br>
                                Particulars: {{ $transaction->particulars }}<br>
                                Status:     @include('admin.transaction.nchlLoadTransaction.status')
                            </address>

                            <address>
                                <strong>Amount: Rs. {{ $transaction->amount }}<br></strong>
                                <strong>Commission: @include('admin.transaction.nchlLoadTransaction.commission')<br></strong>
                            </address>
                                   ...
                                   <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2">
                                       <ul class="timeline">
                                           ...
                                           <li class="timeline-item">
                                               ...
                                               <div class="timeline-content">
                                                   <h2 class="timeline-title">Redirect URL </h2>
                                                   <p>
                                                       <strong>Transaction ID: </strong> {{ $transaction->transaction_id }} <br>
                                                       <strong>Reference ID: </strong> {{ $transaction->reference_id }}
                                                       <br>
                                           ...
                                           <li class="timeline-item">
                                               ...
                                               <div class="timeline-content">
                                                   <h2 class="timeline-title">Validate Transaction</h2>
                                                   <p>
                                                       <strong>Transaction ID: </strong> {{ $transaction->transaction_id }} <br>
                                                       <strong>Reference ID: </strong> {{ $transaction->reference_id }}
                                                       <br>
                                                       <strong>Status: </strong> {{ strtoupper($transaction->status ?? 'NOT COMPLETED') }}
                                                        ...
                                                        @if(!$step3)
                                                               ...
                                                               @elseif($step3NoResponse)
                                                                   <br><strong>Message: </strong>No response from Connect IPS
                                                               <br>
                                                               @endif
                                                           @endif
