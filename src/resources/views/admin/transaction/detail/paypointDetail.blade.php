                ...
                <div class="ibox-content p-xl">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right" style="margin-top: 20px;">
                            <h4>RefStan</h4>
                            <h4 class="text-navy">#{{ $transaction->refStan }}</h4>
                                    ...
                                    <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2">
                                        <ul class="timeline">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <address>
                                                                ...
                                                                <strong>Code:</strong> {{ $transaction->code }} <br><br>
                                            ...
                                            @foreach($transaction->userExecutePayment as $key => $execute)
                                                <li class="timeline-item period">
                                                    <div class="timeline-content">
                                                        <h2 class="timeline-title">STEP 2 (Attempt {{ $loop->index + 1 }})</h2>
                                                    </div>
                                                </li>
                                                <li class="timeline-item">
                                                    <div class="timeline-marker step2{{$key}}"></div>
                                                    <div class="timeline-content">
                                                        <h2 class="timeline-title">Execute Payment (Attempt Number {{ $loop->index + 1 }})</h2>
                                                        <p>
                                                            @if(!empty($execute))
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <address>
                                                                        <strong>Transaction ID:</strong> {{ $execute->transaction_id }} <br>
                                                                        <strong>Code:</strong> {{ $execute->code }} <br>
                                                                        <strong>Bill no:</strong> {{ $execute->bill_no }} <br><br>
                                                                        <strong>Request</strong><br>
