            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get" action="{{ route('transactions.loadTestFundReport') }}" id="filter">
                                    <div class="row">
                                        <div class="col-md-4">
                                    ...
                                    <div style="padding-top: 15px">
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit"
                                                formaction="{{ route('transactions.loadTestFundReport') }}"><strong>Filter</strong>
                                        </button>
                                    </div>
                                    ...
                                    <div>
                                        <button id="excelBtn" class="btn btn-sm btn-warning float-right m-t-n-xs"
                                                ...
                                                formaction="{{route('load_test_fund_report.excel')}}">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example"
                                    ...
                                    @foreach($load_test_fund_reports as $load_test_fund_report)
                                        <tr class="gradeC">
                                            <td>{{$loop->iteration}}</td>
                                            <td>{{$load_test_fund_report->pre_transaction_id}}</td>
                                            <td>{{optional($load_test_fund_report->user)->name}}</td>
                                            <td>{{optional($load_test_fund_report->user)->mobile_no}}</td>
                                            <td>{{optional($load_test_fund_report->user)->email}}</td>
                                            <td>{{$load_test_fund_report->amount}}</td>
                                            <td>{{$load_test_fund_report->created_at}}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
