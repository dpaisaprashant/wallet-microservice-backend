            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get" action="{{ route('nicasia.cyberSourceLoad') }}"
                                      id="filter">
                                    <div class="row">
                                    ...
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit"
                                                formaction="{{ route('nicasia.cyberSourceLoad') }}">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example"
                                    ...
                                    @foreach($transactions as $key=>$transaction)
                                        <tr>
                                            ...
                                            @else
                                                <td><span
                                                        class="badge badge-success">{{$transaction->reason_code}}</span>
                                                </td>
                                            @endif
