                            ...
                            <div class="col-sm-12">
                                <form role="form" method="get" action="{{ route('paypoint') }}" >
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="text" name="refStan" placeholder="ref Stan" class="form-control" value="{{ !empty($_GET['refStan']) ? $_GET['refStan'] : '' }}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <select data-placeholder="Choose paypoint vendor..." class="chosen-select"  tabindex="2" name="vendor">
                                                    <option value="" selected disabled>Select paypoint vendor...</option>
                                            ...
                                            <div class="form-group">
                                                <select data-placeholder="Choose transaction status..." class="chosen-select"  tabindex="2" name="status">
                                                    ...
                                                    @if(!empty($_GET['status']))
                                                        ...
                                                        <option value="failed" @if($_GET['status']  == 'failed') selected @endif>Failed</option>
                                                    @else
                                    ...
                                    <div>
                                        <button id="excelBtn" class="btn btn-sm btn-warning float-right m-t-n-xs" type="submit" style="margin-right: 10px;" formaction="{{ route('paypoint.excel') }}"><strong>Excel</strong></button>
                                    </div>
