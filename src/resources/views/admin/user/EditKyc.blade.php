                                            ...
                                            @if(!empty($user->kyc))
                                                ...
                                                <dd class="col-md-8">
                                                    <div class="input-group date">
                                                        ...
                                                        <input type="text" class="form-control date_from"
                                                               name="date_of_birth" placeholder="Enter Date Of Birth"
                                                               value="{{ $user->kyc->date_of_birth }}" required>
                                                    </div>
                                                </dd>
                                                ...
                                                <dd class="col-md-8">
                                                    <div class="input-group date">
                                                        ...
                                                        <input type="text" class="form-control date_from"
                                                               name="c_issued_date"
                                                               placeholder="Enter Document Issued Date"
                                                               value="{{ $user->kyc->c_issued_date }}" required>
                                                    </div>
                                                </dd>
