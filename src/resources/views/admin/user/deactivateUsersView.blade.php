                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form role="form" method="get">
                                    ...
                                    <div>
                                        <button id="excelBtn" class="btn btn-sm btn-warning float-right m-t-n-xs" type="submit" style="margin-right: 10px;" formaction="{{ route('deactivated.user.excel') }}"><strong>Excel</strong></button>
                                    </div>
