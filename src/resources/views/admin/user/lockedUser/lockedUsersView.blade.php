                                ...
                                @foreach($users as $user)
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">
                                            ...
                                            <a style="margin-top: 5px;" href="{{route('user.login.attempts', $user->id)}}" class="btn btn-sm btn-icon btn-primary m-t-n-xs" title="view attempts"><i class="fa fa-eye"></i></a>
                                            @endcan
                                        </td>
                                    </tr>
                                @endforeach
