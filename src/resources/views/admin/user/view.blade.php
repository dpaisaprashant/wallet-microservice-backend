...
{{--                                            <input type="text" name="transaction_loaded" class="ionrange_loaded_amount">--}}
                                    ...
                                    <br>
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit" formaction="{{ route('user.view') }}"><strong>Filter</strong></button>
                                    </div>
                                ...
                                @foreach($users as $user)
                                    ...
                                    <td class="center">
                                        ...
                                        @endcan
                                            ...
                                            <a style="margin-top: 5px;" href="{{route('user.bank.accounts', $user->id)}}" class="btn btn-sm btn-icon btn-warning m-t-n-xs" title="user bank accounts"><i class="fa fa-bank"></i></a>
