...
<a data-toggle="modal" href="#JsonResponse<?php echo e($preTransaction->id); ?>" ><button class="btn btn-warning btn-icon" type="button"><i class="fa fa-info"></i></button></a>
<div id="JsonResponse<?php echo e($preTransaction->id); ?>" class="modal fade" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="m-t-none m-b">Json Response Info For <br> Pre-Transaction Id: <?php echo e($preTransaction->pre_transaction_id); ?></h3>
                        <hr>
                        <?php
...
<?php endif; ?>
<?php /**PATH /var/www/html/app/Wallet/Microservice/resources/views/preTransactions/preTransactionJsonResponse.blade.php ENDPATH**/ ?>