                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools" style="top: 8px;">
                            <a href="<?php echo e(route('walletBonus.create', $walletTransactionType->id)); ?>"><button class="btn btn-primary" type="button"><i class="fa fa-plus"></i> Create New Bonus</button></a>
                        </div>
                    </div>
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <?php $__currentLoopData = $walletTransactionType->walletTransactionBonus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bonus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                    <tr class="gradeX">
                                        <td><?php echo e($loop->index + 1); ?></td>
                                        <td>
                                            <?php echo e($bonus->title); ?>

                                        </td>
                                        <td>
                                            <?php echo e($bonus->user_type); ?>

                                        </td>
                                        <td>
                                           <?php echo e($bonus->transactionBonusPoint->name); ?>

                                        </td>
                                        <td>
                                            <?php if(isset($bonus->slab_from)): ?>
                                                Rs. <?php echo e($bonus->slab_from / 100); ?>

                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if(isset($bonus->slab_to)): ?>
                                                Rs. <?php echo e($bonus->slab_to / 100); ?>

                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php echo e($bonus->description ?? "Normal Bonus Point"); ?>

                                        </td>

                                        <td><?php echo e($bonus->point_type); ?></td>

                                        <td>
                                            <?php if($bonus->point_type == 'FLAT'): ?>
                                                <?php echo e($bonus->point_value); ?>
                                        ...
                                        <td class="center">
                                            ...
                                            <form action="<?php echo e(route('walletBonus.delete',$bonus->id)); ?>" method="post" id="deactivateForm" style="display: inline">
                                                <?php echo csrf_field(); ?>
                                                <button class="btn btn-danger btn-icon deactivate" rel="<?php echo e($bonus->id); ?>"><i class="fa fa-trash"></i></button>
                                                <button id="deactivateBtn-<?php echo e($bonus->id); ?>" type="submit" style=" display:none;"  rel="<?php echo e(route('architecture.user.cashback.delete')); ?>"></button>
                                            </form>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/app/Wallet/Architecture/resources/views/bonus/user/index.blade.php ENDPATH**/ ?>