        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo e(route('architecture.transaction.commission.create', $walletTransactionType->id)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/app/Wallet/Architecture/resources/views/commission/create.blade.php ENDPATH**/ ?>