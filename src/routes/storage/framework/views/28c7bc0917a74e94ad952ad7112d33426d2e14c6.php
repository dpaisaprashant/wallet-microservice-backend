                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools" style="top: 8px;">
                            <a href="<?php echo e(route('architecture.transaction.commission.create', $walletTransactionType->id)); ?>"><button class="btn btn-primary" type="button"><i class="fa fa-plus"></i> Create New Commission</button></a>
                        </div>
                    </div>
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $walletTransactionType->walletTransactionTypeCommissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <?php echo e($commission->transactionCommissionable->name); ?>
                                        ...
                                        <td class="center">
                                            ...
                                            <form action="<?php echo e(route('architecture.transaction.commission.delete')); ?>" method="post" id="deactivateForm" style="display: inline">
                                                <?php echo csrf_field(); ?>
                                                ...
                                                <button id="deactivateBtn-<?php echo e($commission->id); ?>" type="submit" style=" display:none;"  rel="<?php echo e(route('architecture.transaction.commission.delete')); ?>"></button>
                                            </form>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/app/Wallet/Architecture/resources/views/commission/index.blade.php ENDPATH**/ ?>