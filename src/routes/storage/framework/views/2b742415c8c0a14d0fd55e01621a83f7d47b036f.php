<?php $__env->startSection('content'); ?>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <?php echo $__env->make('admin.userFilter.user-filter',['title' => "Merchant",'excelRoute'=>"kyc.unverified.merchant.excel"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <?php $__currentLoopData = $merchants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$merchant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($merchant->mobile_no); ?></td>

                                        <td><?php echo e($merchant->email); ?></td>

                                        <td><?php echo e($merchant->kyc->company_name == null ? "Null" : $merchant->kyc->company_name); ?></td>

                                        <td class="center">
                                            <a href="<?php echo e(route('merchant.kyc.detail',$merchant->id)); ?>" class="btn btn-sm btn-primary m-t-n-xs"><strong>KYC</strong></a>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/merchant/unverifiedMerchantKYC.blade.php ENDPATH**/ ?>