                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools" style="top: 8px;">
                            <a href="<?php echo e(route('architecture.wallet.merchantRevenue.create', $walletTransactionType->id)); ?>"><button class="btn btn-primary" type="button"><i class="fa fa-plus"></i> Create New Merchant Revenue</button></a>
                        </div>
                    </div>
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $walletTransactionType->walletTransactionTypeMerchantRevenue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $merchant_revenue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="gradeX">
                                        <td><?php echo e($loop->index + 1); ?></td>
                                        <td>
                                            <?php echo e($merchant_revenue->title); ?>

                                        </td>
                                        <td>
                                            <?php if(isset($merchant_revenue->slab_from)): ?>
                                                Rs. <?php echo e($merchant_revenue->slab_from / 100); ?>

                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if(isset($merchant_revenue->slab_to)): ?>
                                                Rs. <?php echo e($merchant_revenue->slab_to / 100); ?>

                                            <?php endif; ?>
                                        </td>

                                        <td><?php echo e($merchant_revenue->merchant_revenue_type); ?></td>

                                        <td>
                                            <?php if($merchant_revenue->merchant_revenue_type  == 'FLAT'): ?>
                                                Rs. <?php echo e($merchant_revenue->merchant_revenue_value  / 100); ?>

                                            <?php else: ?>
                                                <?php echo e($merchant_revenue->merchant_revenue_value); ?>

                                            <?php endif; ?>
                                        </td>

                                        <td>
                                            <?php echo e($merchant_revenue->description ?? "Normal Merchant Revenue"); ?>

                                        </td>
                                        <td><?php echo e($merchant_revenue->user->mobile_no); ?></td>

                                        <td class="center">
                                            
                                            <form action="<?php echo e(route('architecture.wallet.merchantRevenue.delete')); ?>" method="post" id="deactivateForm" style="display: inline">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="id" value="<?php echo e($merchant_revenue->id); ?>">
                                                <button class="btn btn-danger btn-icon deactivate" rel="<?php echo e($merchant_revenue->id); ?>"><i class="fa fa-trash"></i></button>
                                                <button id="deactivateBtn-<?php echo e($merchant_revenue->id); ?>" type="submit" style=" display:none;"  rel="<?php echo e(route('architecture.wallet.merchantRevenue.delete')); ?>"></button>
                                            </form>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/app/Wallet/Architecture/resources/views/merchantRevenue/index.blade.php ENDPATH**/ ?>