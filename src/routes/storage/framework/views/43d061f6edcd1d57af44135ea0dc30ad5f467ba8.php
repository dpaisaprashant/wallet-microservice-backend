                ...
                <div class="ibox-content p-xl">
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="margin-top: 30px;">
                            <h5>User:</h5>
                            <address>
                                <strong><?php echo e($transaction->user['name'] ?? "N/A"); ?></strong><br>
                                Email: <?php echo e($transaction->user['email'] ?? "N/A"); ?><br>
                                Contact Number: <?php echo e($transaction->user['mobile_no'] ?? "N/A"); ?>
                            ...
                            <span>Vendor:</span>
                            <address>
                                <strong><?php echo e($transaction->service_type); ?></strong><br>
                                Transaction Id: <?php echo e($transaction->transaction_id); ?><br>
                        ...
                        <div class="col-sm-6 text-right" style="margin-top: 20px;">
                            ...
                            <h4 class="text-navy">#<?php echo e($transaction->transaction_id); ?></h4>
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/transaction/detail/khaltiDetailView.blade.php ENDPATH**/ ?>