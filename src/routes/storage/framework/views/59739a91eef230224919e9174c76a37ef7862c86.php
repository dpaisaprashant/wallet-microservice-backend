        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo e(route('architecture.user.commission.create', $walletTransactionType->id)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php if(count($availableTitles) > 0): ?>
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Title</label>
                                    <div class="col-sm-10">
                                        <select data-placeholder="Choose Title..." class="chosen-select"  tabindex="2" name="title" required>
                                            <option value="" selected disabled>-- Select Title --</option>
                                            <?php $__currentLoopData = $availableTitles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input name="commission_value" type="number" min="0" step='0.1' class="form-control" required>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        $('#selectUserType').on('change', function (e){
            ...
            let url = `<?php echo e(route('architecture.user.list')); ?>`
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/app/Wallet/Architecture/resources/views/commission/user/create.blade.php ENDPATH**/ ?>