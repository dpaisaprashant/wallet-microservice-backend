            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Frontend process create')): ?>
                            <div class="ibox-tools" style="top: 8px;">
                                <a class="btn btn-primary" href="<?php echo e(route('frontend.process.create')); ?>"> <i class="fa fa-plus-circle"></i> Add New Process</a>
                            </div>
                        <?php endif; ?>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" title="General settings list">
                                ...
                                <?php $__currentLoopData = $processes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $process): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="gradeC">
                                        ...
                                        <td><?php echo e($process->sequence); ?></td>
                                        <td><?php echo e($process->icon); ?></td>
                                        <td>
                                            <?php if(!empty($process->image)): ?>
                                                <img class="d-block w-100"
                                                     src="<?php echo e(config('dpaisa-api-url.public_document_url') . $process->image); ?>"
                                        ...
                                        <td>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Frontend process update')): ?>
                                                <a href="<?php echo e(route('frontend.process.update', $process->id)); ?>"><button class="btn btn-info btn-icon" type="button"><i class="fa fa-edit"></i></button></a>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Frontend process delete')): ?>
                                                <form action="<?php echo e(route('frontend.process.delete')); ?>" method="post" id="deactivateForm" style="display: inline">
                                                <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="id" value="<?php echo e($process->id); ?>">
                                                    <button class="btn btn-danger btn-icon deactivate" rel="<?php echo e($process->id); ?>"><i class="fa fa-trash"></i></button>
                                                    <button id="deactivateBtn-<?php echo e($process->id); ?>" type="submit" style=" display:none;" ></button>
                                                </form>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/frontend/process/index.blade.php ENDPATH**/ ?>