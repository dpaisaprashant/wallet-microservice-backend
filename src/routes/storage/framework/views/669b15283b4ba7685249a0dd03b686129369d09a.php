            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Frontend banner create')): ?>
                            <div class="ibox-tools" style="top: 8px;">
                                <a class="btn btn-primary" href="<?php echo e(route('frontend.banner.create')); ?>"> <i
                                        ...
                                        <tr class="gradeC">
                                            ...
                                            <td>
                                                <?php if(!empty($banner->image)): ?>
                                                    <img src="<?php echo e('172.31.251.2:5052/storage/' . $banner->image); ?>"
                                            ...
                                            <td>
                                                <?php if(!empty($banner->mobile_image)): ?>
                                                    <img src="<?php echo e(config('dpaisa-api-url.public_document_url') . $banner->mobile_image); ?>"
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Frontend banner update')): ?>
                                                    <a href="<?php echo e(route('frontend.banner.update', $banner->id)); ?>"><button
                                                            class="btn btn-info btn-icon" type="button"><i
                                                                class="fa fa-edit"></i></button></a>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Frontend banner delete')): ?>
                                                    <form action="<?php echo e(route('frontend.banner.delete')); ?>" method="post"
                                                        ...
                                                        <button class="btn btn-danger btn-icon deactivate"
                                                            rel="<?php echo e($banner->id); ?>"><i class="fa fa-trash"></i></button>
                                                        <button id="deactivateBtn-<?php echo e($banner->id); ?>" type="submit"
                                                            style=" display:none;"
                                                            rel="<?php echo e(route('frontend.banner.delete')); ?>"></button>
                                                    </form>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/frontend/banner/index.blade.php ENDPATH**/ ?>