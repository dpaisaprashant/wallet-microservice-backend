            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Frontend about create')): ?>
                            <div class="ibox-tools" style="top: 8px;">
                                <a class="btn btn-primary" href="<?php echo e(route('frontend.about.create')); ?>"> <i class="fa fa-plus-circle"></i> Add New About</a>
                            </div>
                        <?php endif; ?>
                    </div>
                                    ...
                                    <tr class="gradeC">
                                        ...
                                        <td>
                                            <?php if(!empty($about->image)): ?>
                                                <img
                                                     src="<?php echo e(config('dpaisa-api-url.public_document_url') . $about->image); ?>"
                                        ...
                                        <td>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Frontend about update')): ?>
                                                <a href="<?php echo e(route('frontend.about.update', $about->id)); ?>"><button class="btn btn-info btn-icon" type="button"><i class="fa fa-edit"></i></button></a>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Frontend about delete')): ?>
                                                <form action="<?php echo e(route('frontend.about.delete')); ?>" method="post" id="deactivateForm" style="display: inline">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="id" value="<?php echo e($about->id); ?>">
                                                    <button id="deactivate" class="btn btn-danger btn-icon deactivate" rel="<?php echo e($about->id); ?>"><i class="fa fa-trash"></i></button>
                                                    <button id="deactivateBtn-<?php echo e($about->id); ?>" type="submit" style=" display:none;" rel="<?php echo e(route('frontend.about.delete')); ?>"></button>
                                                </form>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/frontend/about/index.blade.php ENDPATH**/ ?>