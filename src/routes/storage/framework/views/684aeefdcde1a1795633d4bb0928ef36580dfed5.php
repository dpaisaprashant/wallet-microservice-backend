        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="<?php echo e(route('architecture.wallet.merchantRevenue.create', $walletTransactionType->id)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-sm-10">
                                    <select id="selectMerchant" data-placeholder="Choose Merchant..." class="chosen-select"  tabindex="2" name="user_id" required>
                                        ...
                                        <?php $__currentLoopData = $merchants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $merchant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($merchant->id); ?>"><?php echo e($merchant->name. '-'. $merchant->mobile_no); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/app/Wallet/Architecture/resources/views/merchantRevenue/create.blade.php ENDPATH**/ ?>