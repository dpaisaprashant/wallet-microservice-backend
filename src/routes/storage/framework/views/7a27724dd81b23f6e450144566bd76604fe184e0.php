        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form method="post"
                              action="<?php echo e(route('architecture.transaction.cashback.create', $walletTransactionType->id)); ?>"
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/app/Wallet/Architecture/resources/views/cashback/create.blade.php ENDPATH**/ ?>