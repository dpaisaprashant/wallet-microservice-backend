<?php $__env->startSection('content'); ?>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <?php echo $__env->make('admin.userFilter.user-filter',['title' => "Merchant",'excelRoute'=>"kyc.notfilled.merchant.excel"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>List of Unfilled KYC Merchants</h5>
                    </div>
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example"
                                ...
                                <tbody>
                                <?php $__currentLoopData = $kycNotFilledUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="gradeX">
                                        <td><?php echo e($loop->index + ($kycNotFilledUsers->perPage() * ($kycNotFilledUsers->currentPage() - 1)) + 1); ?></td>
                                        <td>
                            ...
                            <?php echo e($kycNotFilledUsers->appends(request()->query())->links()); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        $(document).ready(function (e) {
            ...
            let a = "Showing <?php echo e($kycNotFilledUsers->firstItem()); ?> to <?php echo e($kycNotFilledUsers->lastItem()); ?> of <?php echo e($kycNotFilledUsers->total()); ?> entries";
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/merchant/kycNotFilledMerchant.blade.php ENDPATH**/ ?>