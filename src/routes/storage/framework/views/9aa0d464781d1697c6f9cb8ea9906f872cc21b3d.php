<?php $__env->startSection('content'); ?>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <?php echo $__env->make('admin.userFilter.user-filter',['title' => "User",'excelRoute'=>"kyc.accepted.user.excel"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>List of Accepted KYC users</h5>
                    </div>
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/user/acceptedKycUser.blade.php ENDPATH**/ ?>