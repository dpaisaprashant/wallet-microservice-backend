<?php $__env->startSection('content'); ?>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Frontend Solutions Settings</h2>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>List of all Solutions</h5>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Frontend solution create')): ?>
                            <div class="ibox-tools" style="top: 8px;">
                                <a class="btn btn-primary" href="<?php echo e(route('frontend.solution.create')); ?>"> <i class="fa fa-plus-circle"></i> Add New Solution</a>
                            </div>
                        <?php endif; ?>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" title="General settings list">
                                ...
                                <?php $__currentLoopData = $solutions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $solution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="gradeC">
                                        ...
                                        <td>
                                            <img
                                                src="<?php echo e(config('dpaisa-api-url.public_document_url') . $solution->image); ?>"
                                                alt="Solution Image" style="height: 120px;">
                                        </td>
                                        <td><?php echo e($solution->title); ?></td>
                                        <td><?php echo e($solution->description); ?></td>
                                        <td><?php echo e($solution->created_at); ?></td>
                                        <td>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Frontend solution update')): ?>
                                                <a href="<?php echo e(route('frontend.solution.update',$solution->id)); ?>"><button class="btn btn-info btn-icon" type="button"><i class="fa fa-edit"></i></button></a>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Frontend solution delete')): ?>
                                                <form action="<?php echo e(route('frontend.solution.delete')); ?>" method="post" id="deactivateForm" style="display: inline">
                                                <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="id" value="<?php echo e($solution->id); ?>">
                                                    <button id="deactivate" class="btn btn-danger btn-icon deactivate" rel="<?php echo e($solution->id); ?>"><i class="fa fa-trash"></i></button>
                                                    <button id="deactivateBtn-<?php echo e($solution->id); ?>" type="submit" style=" display:none;" rel="<?php echo e(route('frontend.solution.delete')); ?>"></button>
                                                </form>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/frontend/solution/index.blade.php ENDPATH**/ ?>