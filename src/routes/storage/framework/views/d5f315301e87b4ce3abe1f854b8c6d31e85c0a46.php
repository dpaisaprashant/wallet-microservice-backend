    ...
    <td>
        ...
        <?php if($event->microservice_type == "BFI"): ?>
            <?php if(!empty($event->userToBFIFundTransfer)): ?>
                <a href="<?php echo e(route('user.to.bfi.fund.transfer.check.payment', $event->userToBFIFundTransfer->id)); ?>">
                    <button class="btn btn-primary btn-icon" type="button"><i class="fa fa-eye"></i></button>
                </a>
            <?php endif; ?>
        ...
        <?php if($event->nicAsiaCyberSourceLoad): ?>
            <a href="<?php echo e(route('nicAsia.detailCyberSourceLoad',$event->nicAsiaCyberSourceLoad->id)); ?>"><button class="btn btn-primary btn-icon" type="button"><i class="fa fa-eye"></i></button></a>
        <?php elseif($event->userloadTransaction): ?>
            <a href="<?php echo e(route('eBanking.detail', $event->userLoadTransaction->id)); ?>"><button class="btn btn-primary btn-icon" type="button"><i class="fa fa-eye"></i></button></a>
        <?php elseif($event->userTransaction): ?>
            <a href="<?php echo e(route('paypoint.detail', $event->userTransaction->id)); ?>">    <button class="btn btn-primary btn-icon" type="button"><i class="fa fa-eye"></i></button></a>
        
        <?php elseif($event->nchlBankTransfer): ?>
            <a href="<?php echo e(route('nchl.bankTransfer.detail', $event->nchlBankTransfer->id)); ?>"><button class="btn btn-primary btn-icon" type="button"><i class="fa fa-eye"></i></button></a>
        <?php elseif($event->nchlLoadTransaction): ?>
            <a href="<?php echo e(route('nchl.loadTransaction.detail', $event->nchlLoadTransaction->id)); ?>"><button class="btn btn-primary btn-icon" type="button"><i class="fa fa-eye"></i></button></a>
        <?php elseif($event->nchlAggregatePayment): ?>
            <a href="<?php echo e(route('nchl.aggregatedPayment.detail',$event->nchlAggregatePayment->id)); ?>"><button class="btn btn-primary btn-icon" type="button"><i class="fa fa-eye"></i></button></a>
        
        <?php elseif(optional($event->transactionEvent)->transaction_type == \App\Models\UserToUserFundTransfer::class): ?>
            <a href="<?php echo e(route('userToUserFundTransfer.detail', $event->transactionEvent->transaction_id)); ?>"><button class="btn btn-primary btn-icon" type="button"><i class="fa fa-eye"></i></button></a>
        <?php elseif(optional($event->transactionEvent)->transaction_type == \App\Models\FundRequest::class): ?>
            <a href="<?php echo e(route('fundRequest.detail', $event->transactionEvent->transaction_id)); ?>"><button class="btn btn-primary btn-icon" type="button"><i class="fa fa-eye"></i></button></a>
        <?php elseif($event->npsLoadTransaction): ?>
                <a href="<?php echo e(route('nps.detail',$event->npsLoadTransaction->id)); ?>"><button class="btn btn-primary btn-icon" type="button"><i class="fa fa-eye"></i></button></a>
        <?php endif; ?>
