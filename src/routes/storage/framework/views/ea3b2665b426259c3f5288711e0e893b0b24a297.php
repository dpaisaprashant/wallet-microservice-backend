                                ...
                                <form role="form" method="get">
                                    ...
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit"
                                                formaction="<?php echo e(route('user.showAdminUpdatedKyc')); ?>"><strong>Filter</strong></button>
                                    </div>

                                    <div>
                                        <button id="excelBtn" class="btn btn-sm btn-warning float-right m-t-n-xs"
                                                type="submit" style="margin-right: 10px;"
                                                formaction="<?php echo e(route('admin-updated-kyc.excel')); ?>"><strong>Excel</strong></button>
                                    </div>
                    ...
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example"
                                ...
                                <tbody>
                                <?php $__currentLoopData = $adminUpdatedKycs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adminUpdatedKyc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="gradeX">
                                        <td><?php echo e($loop->index + ($adminUpdatedKycs->perPage() * ($adminUpdatedKycs->currentPage() - 1)) + 1); ?></td>
                                        <td>
                                            &nbsp;<?php echo e($adminUpdatedKyc->admin->name); ?>

                                        </td>
                                        <td><?php echo e(optional(optional($adminUpdatedKyc->userKyc)->user)->mobile_no); ?></td>
                                        <td>
                                            <?php
                                        ...
                                        <td><?php echo $__env->make('admin.user.AdminUpdateKycJsonDecode', ['adminUpdatedKyc' => $adminUpdatedKyc,'type'=>"before_change"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></td>
                                        <td><?php echo $__env->make('admin.user.AdminUpdateKycJsonDecode', ['adminUpdatedKyc' => $adminUpdatedKyc,'type'=>"after_change"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></td>
                                        <td><?php echo e($adminUpdatedKyc->created_at); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                </tbody>
                            </table>
                            <?php echo e($adminUpdatedKycs->appends(request()->query())->links()); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        $(document).ready(function (e) {
            let a = "Showing <?php echo e($adminUpdatedKycs->firstItem()); ?> to <?php echo e($adminUpdatedKycs->lastItem()); ?> of <?php echo e($adminUpdatedKycs->total()); ?> entries";
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/user/AdminUpdatedKyc.blade.php ENDPATH**/ ?>