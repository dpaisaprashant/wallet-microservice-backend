    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>NCHL Load Transaction</strong>
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title collapse-link">
                        <h5>Filter NCHL Load Transactions</h5>
                                ...
                                <form role="form" method="get">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="text" name="reference_id" placeholder="Reference ID"
                                                       class="form-control"
                                                       value="<?php echo e(!empty($_GET['reference_id']) ? $_GET['reference_id'] : ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select data-placeholder="Choose transaction status..."
                                                    ...
                                                    <?php if(!empty($_GET['status'])): ?>
                                                        ...
                                                        <option value="NOT_COMPLETED"
                                                                <?php if($_GET['status']  == 'NOT_COMPLETED'): ?> selected <?php endif; ?>>
                                                            NOT COMPLETED
                                                        </option>
                                                    <?php else: ?>
                                    ...
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit"
                                                formaction="<?php echo e(route('nchl.loadTransaction')); ?>"><strong>Filter</strong>
                                        </button>
                                    </div>
                                    ...
                                    <div>
                                        <button id="excelBtn" class="btn btn-sm btn-warning float-right m-t-n-xs" type="submit" style="margin-right: 10px;" formaction="<?php echo e(route('nchlLoadTransaction.excel')); ?>"><strong>Excel</strong></button>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>List of NCHL Load Transactions</h5>
                        </div>
                        <div class="ibox-content">
                            <h5><b>Total Count:</b> <?php echo e($totalNchlLoadTransactionCount); ?></h5>
                            <h5><b>Total Amount Sum:</b> Rs. <?php echo e($totalNchlLoadTransactionSum); ?></h5>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example"
                                    ...
                                    <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="gradeC">
                                            ...
                                            <td>
                                                Rs. <?php echo e($transaction->amount ?? 0); ?>

                                            </td>

                                            <td>
                                                <?php echo $__env->make('admin.transaction.nchlLoadTransaction.commission', ['transaction' => $transaction], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </td>

                                            <td>
                                                <?php echo $__env->make('admin.transaction.nchlLoadTransaction.status', ['transaction' => $transaction], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </td>
                                            ...
                                            <td>
                                                <?php echo $__env->make('admin.transaction.nchlLoadTransaction.response', ['$transaction' => $transaction], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </td>
                                            <td>
                                                <a href="<?php echo e(route('nchl.loadTransaction.detail', $transaction->id)); ?>">
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/transaction/nchlLoadTransaction.blade.php ENDPATH**/ ?>