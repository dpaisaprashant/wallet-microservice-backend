                ...
                <div class="ibox-content p-xl">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                            <?php $__currentLoopData = $transaction->transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($transaction->transactions[$key]->vendor == "Transfer Funds"): ?>
                                    <h4>From User Transaction ID:</h4>
                                    <h4 class="text-navy">#<?php echo e($transaction->transactions[$key]->pre_transaction_id); ?></h4>
                                <?php else: ?>
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/transaction/detail/fundRequestDetail.blade.php ENDPATH**/ ?>