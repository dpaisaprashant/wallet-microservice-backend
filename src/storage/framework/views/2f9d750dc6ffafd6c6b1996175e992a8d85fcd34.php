                                ...
                                <form role="form" method="get">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <select data-placeholder="Choose transaction credit status..."
                                                    ...
                                                    <option value="">All</option>
                                                    <?php if(!empty($_GET['credit_status'])): ?>
                                                        <option value="SUCCESS"
                                                                <?php if($_GET['credit_status']  == 'SUCCESS'): ?> selected <?php endif; ?>>
                                                            SUCCESS
                                                        </option>
                                                        <option value="ERROR"
                                                                <?php if($_GET['credit_status']  == 'ERROR'): ?> selected <?php endif; ?>>
                                                            ERROR
                                                        </option>
                                                        <option value="NOT_COMPLETED"
                                                                <?php if($_GET['credit_status']  == 'NOT_COMPLETED'): ?> selected <?php endif; ?>>
                                                            NOT COMPLETED
                                                        </option>
                                                    <?php else: ?>
                                                        <option value="SUCCESS">SUCCESS</option>
                                    ...
                                    <div>
                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs" type="submit"
                                                formaction="<?php echo e(route('nchl.bankTransfer')); ?>"><strong>Filter</strong>
                                        </button>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <h5><b>Total Count:</b> <?php echo e($totalNchlLoadBankTransferTransactionCount); ?></h5>
                            <h5><b>Total Amount Sum:</b> Rs. <?php echo e($totalNchlLoadBankTransferTransactionSum); ?></h5>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example"
                                    ...
                                    <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="gradeC">
                                            ...
                                            <td>
                                                Rs. <?php echo e($transaction->commission_amount); ?>

                                            </td>
                                            <td>
                                                <?php echo $__env->make('admin.transaction.nchlBankTransfer.debitStatus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </td>
                                            <td>
                                                <?php echo $__env->make('admin.transaction.nchlBankTransfer.creditStatus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </td>
                                            <td class="center"><?php echo e($transaction->updated_at); ?></td>
                                            <td>
                                                <?php echo $__env->make('admin.transaction.nchlBankTransfer.account', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </td>
                                            <td>
                                                <?php echo $__env->make('admin.transaction.nchlBankTransfer.request', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </td>
                                            <td>
                                                <?php echo $__env->make('admin.transaction.nchlBankTransfer.response', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </td>
                                            <td>
                                                <form
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/transaction/nchlBankTransfer.blade.php ENDPATH**/ ?>