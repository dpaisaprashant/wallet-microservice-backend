...
<?php echo $__env->make('admin.userFilter.user-filter',['title' => "User"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example"
                                ...
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="gradeX">
                                            ...
                                            <td><?php echo e(optional($user->prizeCode)->code); ?></td>
                                            ...
                                            <td>Rs. <?php echo e($user->wallet->bonus_balance); ?></td>
                                            ...
                                            <td class="center">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('View all audit trial','User profile')): ?>
                                                    <a style="margin-top: 5px;"
                                                       href="<?php echo e(route('user.new.audit_trail',['wallet' => "wallet",'id' => $user->id])); ?>"
                                                       class="btn btn-sm btn-icon btn-primary m-t-n-xs"
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/user/view.blade.php ENDPATH**/ ?>