                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" title="Lock users list">
                                ...
                                <?php $__currentLoopData = $merchants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $merchant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <a  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('User profile')): ?> href="<?php echo e(route('user.profile', $merchant->id)); ?>" <?php endif; ?>><?php echo e($merchant->name); ?></a>
                                        </td>
                                        <td>
                                            <?php if(!empty($merchant->phone_verified_at)): ?>
                                                <i class="fa fa-check-circle" style="color: green;"></i> &nbsp;<?php echo e($merchant->mobile_no); ?>

                                            <?php else: ?>
                                                <i class="fa fa-times-circle" style="color: red;"></i>&nbsp;<?php echo e($merchant->mobile_no); ?>

                                            <?php endif; ?>
                                        </td>
                                        <td class="center">
                                            <?php if(!empty($merchant->email_verified_at)): ?>
                                                <i class="fa fa-check-circle" style="color: green;"></i> &nbsp;<?php echo e($merchant->email); ?>

                                            <?php else: ?>
                                                <i class="fa fa-times-circle" style="color: red;"></i>&nbsp;<?php echo e($merchant->email); ?>

                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if($merchant->isLocked()): ?>
                                        ...
                                        <td class="center">
                                            ...
                                            <a style="margin-top: 5px;" href="<?php echo e(route('merchant.login.attempts', $merchant->id)); ?>" class="btn btn-sm btn-icon btn-primary m-t-n-xs" title="view attempts"><i class="fa fa-eye"></i></a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/merchant/lockedMerchant/lockedUsersView.blade.php ENDPATH**/ ?>