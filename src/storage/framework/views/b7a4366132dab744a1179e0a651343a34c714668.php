        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <div style="width: 38%">
                        <h5>User Transaction Amount for the year
                        </h5>
                    </div>
                </div>
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <form id="userGraphForm" role="form" method="post" action="<?php echo e(route('user.yearly.graph')); ?>">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/resources/views/admin/user/profile/tabs/transactionGraph.blade.php ENDPATH**/ ?>